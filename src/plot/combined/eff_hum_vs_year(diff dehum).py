...
def plot_eff_hum_vs_time(loc, show, write):
    ...
    # Set plot title
    plt.title(f"Absolute Humidity [g/m^3] and Efficiency [L/kWh] Vs. Time ({loc}) (May To November 2023) (diff dehum analysis)")
    
    # Save the plot if requested
    if write == 'Y':
        plot_filename = fr'C:\Users\ajayj\DehumGraph\plots\Effic_AH_Vs_Time ({loc}) (May_Nov_2023) (diff dehum analysis).png'
...
if __name__ == '__main__':
    loc = input("Enter a location to plot Effic and A.H. Vs. Time (guestroom or frontdoor): ")
